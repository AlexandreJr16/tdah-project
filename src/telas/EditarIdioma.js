...
import { CheckBox, Text, View, StyleSheet, TouchableOpacity,} from 'react-native';
import { firebase } from '../../config';
import { useState, useEffect } from 'react';
import { Ionicons, MaterialIcons, Feather, FontAwesome, AntDesign, Entypo} from '@expo/vector-icons';

export default function EditarIdioma (props){
    ...
    return(
        ...
        <View style={estilos.container}>
            ...
            <Text style={estilos.title}>Alterar Idioma</Text>
